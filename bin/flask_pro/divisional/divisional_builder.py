...
class DivisionalBuilder(Builder):
    """
    Define class DivisionalBuilder with attribute(s) and method(s).
    ...
    def __init__(self):
        ...
        """
        verbose_message(
            DivisionalBuilder.VERBOSE, verbose, 'Initial divisional builder'
        )
        super(DivisionalBuilder, self).__init__()
        self.new_project()

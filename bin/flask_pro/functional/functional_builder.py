...
class FunctionalBuilder(Builder):
    """
        Define class FunctionalBuilder with attribute(s) and method(s).
    ...
    def __init__(self, verbose=False):
        ...
        """
        verbose_message(
            FunctionalBuilder.VERBOSE, verbose, 'Initial functional builder'
        )
        super(FunctionalBuilder, self).__init__()
        self.new_project()

    def generate_structure(self, project_name, project_schema_path):
        """
            :param project_name: Project name (root folder)
            :type project_name: <str>
            :param project_schema_path: Absolute path of schema file

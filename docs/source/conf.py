...
project: str = 'gen_flask_pro'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '1.2.0'
release: str = 'https://github.com/vroncevic/gen_flask_pro/releases'
...
htmlhelp_basename: str = 'gen_flask_prodoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_flask_pro.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_flask_pro', 'gen_flask_pro Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_flask_pro', 'gen_flask_pro Documentation', author,

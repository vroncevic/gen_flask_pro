...
Info
    Defines class GenFlaskPro with attribute(s) and method(s).
...
try:
    ...
    from gen_flask_pro.pro import GenSetup
...
class GenFlaskPro(CfgCLI):
    '''
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenFlaskPro constructor.
                | process - Processes and runs operations.
    '''

    _GEN_VERBOSE: str = 'GEN_FLASK_PRO'
    _CONFIG: str = '/conf/gen_flask_pro.cfg'
    _LOG: str = '/log/gen_flask_pro.log'
    _LOGO: str = '/conf/gen_flask_pro.logo'
    ...
    def __init__(self, verbose: bool = False):
        ...
        gen_flask_pro_property: Dict[str, str | bool] = {
        ...
        Splash(gen_flask_pro_property, verbose)

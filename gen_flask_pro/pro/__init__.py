...
'''
 ...
 Info
     Defined class GenGen_flask_pro with attribute(s) and method(s).
...
try:
    from gen_flask_pro.pro.read_template import ReadTemplate
    from gen_flask_pro.pro.write_template import WriteTemplate
...
class GenFlaskProSetup(FileChecking):
    '''
        Defined class GenGen_flask_pro with attribute(s) and method(s).
        Generate module file generator_test.py by template and parameters.
        It defines:
            ...
            :methods:
                ...
                | __str__ - dunder method for GenFlaskProSetup.
    '''

    GEN_VERBOSE = 'GEN_FLASK_PRO::PRO::GEN_SETUP'
    ...
    def __init__(self, verbose=False):
        ...
        verbose_message(GenFlaskProSetup.GEN_VERBOSE, verbose, 'init setup')
    ...
    def gen_setup(self, pro_name, verbose=False):
        ...
        verbose_message(
            GenFlaskProSetup.GEN_VERBOSE, verbose,
    ...
    def __str__(self):
        '''
            Dunder method for GenGen_flask_pro.

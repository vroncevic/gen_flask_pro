...
Info
    ...
    Generates a Flask project structure.
'''
...
class GenSetup(FileCheck, ProConfig, ProName):
    '''
        Defined class GenFlaskProSetup with attribute(s) and method(s).
        Generates a Flask project structure.
    ...
    _GEN_VERBOSE: str = 'GEN_FLASK_PRO::PRO::GEN_SETUP'

...
Info
    Defines setup for tool gen_flask_pro.
'''
...
setup(
    ...
    package_data={
        'gen_flask_pro': [
            f'{CONF}/gen_flask_pro.logo',
            f'{CONF}/gen_flask_pro.cfg',
            f'{CONF}/gen_flask_pro_util.cfg',
            f'{CONF}/project.yaml',
            f'{TEMPLATE}/generator_test.template',
            f'{LOG}/gen_flask_pro.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            f'{TOOL_DIR}run/gen_flask_pro_run.py'
        ]
    )]
)
